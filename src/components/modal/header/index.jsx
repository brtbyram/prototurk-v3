        ...
        <header className='h-14 border-b border-zinc-300 dark:border-zinc-700 flex items-center justify-between pl-6 pr-2.5'>
            ...
            {!disableClose && (
                <button
                    ...
                    className='w-9 h-9 rounded transition-colors flex items-center justify-center text-zinc-400 dark:text-zinc-500 hover:text-black hover:bg-zinc-100 dark:hover:bg-zinc-700 dark:hover:text-white'
                >
                    <IoClose size={20} />
                </button>
            )}
