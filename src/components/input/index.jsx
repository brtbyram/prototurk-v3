...
export default function Input({ label, name, ...props }) {
    return (
        <div>
            ...
            <Field
                name={name}
                className="w-full h-10 bg-zinc-50 dark:bg-zinc-800 border border-zinc-300 dark:border-zinc-700 rounded outline-none px-3 text-15 font-medium dark:focus:border-zinc-500 dark:text-white"
                {...props}
            />
