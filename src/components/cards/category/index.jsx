...
export default function CategoryCard({item}) {
    return (
        ...
        >
            ...
            <div className='border-t border-zinc-200 dark:border-zinc-700 group-hover:border-zinc-400 dark:group-hover:border-zinc-600 grid grid-cols-2 gap-x-4 pt-4 mt-4 text-sm text-zinc-500 dark:text-zinc-400 group-hover:text-black dark:group-hover:text-white'>
