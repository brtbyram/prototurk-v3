...
export default function ArticleCard({ item, style }) {
  return (
    <Link
      ...
      className={classNames("p-5 border hover:border-zinc-300 dark:hover:border-zinc-600 rounded-md flex flex-col bg-white dark:bg-zinc-900 dark:border-zinc-700 relative",{
        "before:absolute before:w-[90%] before:h-full before:-bottom-1.5 before:left-1/2 before:-translate-x-1/2 before:bg-zinc-200/80 dark:before:bg-zinc-700  before:z-[-1] before:rounded-b": style
      })}>
      <div
